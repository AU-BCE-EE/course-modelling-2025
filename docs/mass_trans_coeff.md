# Some information on mass transfer coefficients 
...
However, in many cases it is possible to assume that one phase dominates resistance.
For mass transfer from a water solution to air, for example, volatilization of highly soluble compounds tends to be limited by air-side resistance, because there is a high concentration of solute within the water-side film.
